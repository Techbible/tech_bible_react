        ...
        <div className="bg-[#1D1D1F] shadow rounded lg:w-1/3  md:w-1/2 w-full p-10">
          ...
          <div className="mt-8">
            <button
              ...
              className="focus:ring-2 focus:ring-offset-2 text-[18px] transition .5s focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-[#ef4823] border rounded hover:bg-[#b32712] py-4 w-full"
              ref={signUpRef}
            >
              Create my account
            </button>
