    ...
    <div className="mt-desktop-20 mt-mobile-8 mt-tablet-8 mt-widescreen-10 layoutContainer ">
      <main className="layoutMain">
        <div class="flex flex-col mb-12 p-5 text-white">
          ...
          <button class="bg-white text-black py-2  rounded w-25 mt-2 transition delay-150 hover:font-bold hover:delay-200 mt-4 ">
            New Discussion
          </button>
        </div>
            ...
            <form className="ml-20">
              ...
              <div class="relative">
                ...
                <input
                  type="search"
                  id="default-search"
                  class="flex block w-full p-1 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
