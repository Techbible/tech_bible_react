    ...
    <div className="home-container mt-desktop-30 mt-mobile-12 mt-tablet-8 mt-widescreen-20 layoutContainer">
      <main className="layoutMain">
        <div class="flex direction-column">
          <div>
            <div>
              <div className="max-w-[816px] mx-auto flex flex-column py-2 my-4 md:mb-[2rem] lg:h-[198px] lg:w-[900px] p-[30px] rounded-xl bg-gradient-to-r from-[#18151D] to-[#27242E]">
