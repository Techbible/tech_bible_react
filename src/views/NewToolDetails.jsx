  ...
  return (
    <div className="mt-desktop-30 mt-mobile-8 mt-tablet-8 mt-widescreen-20 layoutContainer mt-[6rem]">
      <div className="home-container mt-desktop-30 mt-mobile-8 mt-tablet-8 mt-widescreen-20 layoutContainer">
              ...
              <div className="flex direction-column flex-1">
                ...
                <div className="color-white fontSize-mobile-12 fontSize-desktop-16 fontSize-tablet-16 fontSize-widescreen-16 fontWeight-400 noOfLines-2">
                  <span className="styles_tagline__j29pO">
                    ...
                    websites or mobile applications. It is aimed at UX/UI
                    designers
                  </span>
                </div>
                <div className="flex direction-row flex-row-gap-6 mt-3 align-center">
                  <div className="flex direction-row flex-row-gap-3">
                    <div className="color-white fontSize-12 fontWeight-400 noOfLines-undefined border-1 border-white px-3 bg-gradient">
                      Premium
                    </div>
                    <a
        ...
        <aside className="sidebarWithSeparator right"></aside>
      </div>
    </div>
  );
};
